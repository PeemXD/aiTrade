...
import (
	...
	aimodel "github.com/local/polymarket-fetch-data-service/pkg/model/ai"
	execmodel "github.com/local/polymarket-fetch-data-service/pkg/model/execution"
	marketmodel "github.com/local/polymarket-fetch-data-service/pkg/model/market"
	matchmodel "github.com/local/polymarket-fetch-data-service/pkg/model/match"
	newsmodel "github.com/local/polymarket-fetch-data-service/pkg/model/news"
	positionmodel "github.com/local/polymarket-fetch-data-service/pkg/model/position"
	probmodel "github.com/local/polymarket-fetch-data-service/pkg/model/probability"
	riskmodel "github.com/local/polymarket-fetch-data-service/pkg/model/risk"
)
